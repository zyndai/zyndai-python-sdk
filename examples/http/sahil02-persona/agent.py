"""
sahil02-persona — LangChain Agent on ZyndAI Network
...
def create_agent():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are sahil02-persona, a helpful AI assistant."),
...
if __name__ == "__main__":
    agent_config = AgentConfig(
        name=_config.get("name", "sahil02-persona"),
        description=_config.get("description", "sahil02-persona — a LangChain agent on the ZyndAI network."),
        capabilities={
            "ai": ["nlp", "langchain"],
            "protocols": ["http"],
        },
        ...
        summary=_config.get("summary", "sahil02-persona agent"),
        webhook_host="0.0.0.0",
        webhook_port=_config.get("webhook_port", 5002),
    ...
    print(f"\nsahil02-persona is running (LangChain)")
