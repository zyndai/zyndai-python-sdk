"""
swapnil-tes — LangChain Agent on ZyndAI Network
...
def create_agent():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are swapnil-tes, a helpful AI assistant."),
...
if __name__ == "__main__":
    ...
    print(f"\nswapnil-tes is running (LangChain)")
